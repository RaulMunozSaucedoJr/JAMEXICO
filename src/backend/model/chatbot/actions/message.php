...
$conn = mysqli_connect("localhost", "root", "", "crud") or die("Database Error");
...
if (mysqli_num_rows($run_query) > 0) {
    ...
    echo "¡Lo siento, NO entiendo su busqueda. Ingrese preguntas/palabras clave para una mayor precisión de respuesta!:
    
    </br><a href='https://www.jamexico.org.mx/'>Contacto: JA - México</a>";
}